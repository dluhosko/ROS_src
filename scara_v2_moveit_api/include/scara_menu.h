...
std_msgs::Byte selectedMode, gripperStateMsg;
        ...
        if ((teachPositionsHand[currentMode][0] - maxJointDeviation < currentJointStates.position[0]) &&
            ...
            if ((teachPositionsHand[currentMode][1] - maxJointDeviation < currentJointStates.position[1]) &&
                ...
                if ((teachPositionsHand[currentMode][2] - maxJointDeviation < currentJointStates.position[2]) &&
                    ...
                    ROS_INFO("J3 not in place %f [%f]", currentJointStates.position[3], teachPositionsHand[currentMode][2]);
            } else
                ROS_INFO("J2 not in place %f/%f/%f [%f]", currentJointStates.position[0], currentJointStates.position[1], currentJointStates.position[2], teachPositionsHand[currentMode][1]);
        } else
            ROS_INFO("J1 not in place %f/%f/%f [%f]", currentJointStates.position[0], currentJointStates.position[1], currentJointStates.position[2], teachPositionsHand[currentMode][0]);
